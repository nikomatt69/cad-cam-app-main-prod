...
export default function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Se scrolliamo all'interno del Layout, accediamo al suo contenitore
    ...
    // Cattura anche gli eventi di scroll all'interno del layout
      ...
      <Layout>
        <div className="p-6 "  ref={contentRef}>
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl flex  px-5 font-bold text-gray-900"> <img src='/logo.png' className='h-28 mr-2'/> </h1>
            ...
            <div className="bg-[#F8FBFF]  dark:bg-gray-600 dark:text-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-gray-900">CAD Editor</h2>
                    <p className="text-sm text-gray-500">Create and edit designs</p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="bg-blue-600 text-white w-full px-4 py-2 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                >
                  Open CAD Editor
                </button>
              </div>
            ...
            <div className="bg-[#F8FBFF]  dark:bg-gray-600 dark:text-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-gray-900">CAM Editor</h2>
                    <p className="text-sm text-gray-500">Generate toolpaths</p>
                  </div>
                </div>
                <p className="text-gray-600 mb-4">
                ...
                <button
                  ...
                  className="bg-green-600 text-white w-full px-4 py-2 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50"
                >
                  Open CAM Editor
                </button>
              </div>
            ...
            <div className="bg-[#F8FBFF]  dark:bg-gray-600 dark:text-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <button
                  ...
                  className="bg-purple-600 text-white w-full px-4 py-2 rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50"
                >
                  Browse Projects
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            {/* Resources section - 2/3 width on large screens */}
            <div className="lg:col-span-2">
              <div className="bg-[#F8FBFF]  dark:bg-gray-600 dark:text-white shadow-md rounded-lg overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                  ...
                  <Link href="/resources" className="text-sm text-blue-600 hover:text-blue-800">
                    View all
                  </Link>
                </div>
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* Materials */}
                  <Link href="/materials" className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    <div>
                      <h3 className="text-md font-medium text-gray-900">Materials</h3>
                  ...
                  {/* Components */}
                  <Link href="/components" className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="h-10 w-10 rounded-lg bg-green-100 flex items-center justify-center mr-4">
                      <Box className="h-5 w-5 text-green-600" />
                    </div>
                    <div>
                      <h3 className="text-md font-medium text-gray-900">Components</h3>
                      <p className="text-sm text-gray-500">
                  ...
                  <Link href="/machine" className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="h-10 w-10 rounded-lg bg-blue-100 flex items-center justify-center mr-4">
                      <Settings className="h-5 w-5 text-blue-600" />
                    </div>
                    <div>
                      <h3 className="text-md font-medium text-gray-900">Machine Configs</h3>
                      <p className="text-sm text-gray-500">CNC machine settings</p>
                    </div>
                  </Link>
                  
                  {/* Drawing Instruments */}
                  <Link href="/drawing-instruments" className="flex items-center p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    <div>
                      <h3 className="text-md font-medium text-gray-900">Drawing Instruments</h3>
                      <p className="text-sm text-gray-500">Configure drawing tools</p>
                    </div>
                  </Link>
                </div>
              </div>
            ...
            {/* Tools section - 1/3 width on large screens */}
            <div>
              <div className="bg-[#F8FBFF]  dark:bg-gray-600 dark:text-white shadow-md rounded-lg overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                  <h2 className="text-lg font-semibold text-gray-900">Tools</h2>
                  <Link href={`/tools`} className="text-sm text-blue-600 hover:text-blue-800">
                    View all
                  </Link>
                </div>
                <div className="p-6">
                  {stats && stats.totalTools > 0 ? (
                    <div className="text-center py-4">
                      <div className="w-20 h-20 rounded-full bg-orange-100 flex items-center justify-center mx-auto mb-3">
                        <Tool className="h-10 w-10 text-orange-600" />
                      </div>
                      <h3 className="text-2xl font-bold text-gray-900">{stats.totalTools}</h3>
                      <p className="text-gray-500">Cutting tools ready for use</p>
                      <Link href="/tools/index" className="mt-4 inline-block text-sm text-blue-600 hover:text-blue-800">
                        Add a new tool
                      </Link>
                    </div>
                  ) : (
                    <div className="text-center py-6">
                      ...
                      <h3 className="text-gray-900 font-medium mb-2">No Tools Yet</h3>
          ...
          <div className="bg-[#F8FBFF]  dark:bg-gray-600 dark:text-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="divide-y divide-gray-200 max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
